<template>
    <div class="w-full h-screen overflow-auto">
        ...
        <div class="container flex flex-col items-center justify-center gap-y-4 pt-6">
            <img src="@/assets/images/forgotpassword.svg" alt="Forgot Password Image" class="mb-4 w-80 h-80 object-cover">
