...
export default {
    ...
    data() {
        return {
            routeName : null,
            menu : [
                { route : 'home', icon : 'home', name : 'Beranda' },
                { route : 'transaksi', icon : 'file-invoice' , name : 'Transaksi' },
                { route : 'bantuan', icon : 'circle-question' , name : 'Bantuan' },
                { route : 'akun', icon : 'circle-user' , name : 'Akun' },
            ],
            transparent : {
                opacity : '0.3'
            },
